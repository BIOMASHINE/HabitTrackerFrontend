...
submit.onclick = async function registering() {
    ...
    try {
        const response = await fetch('https://habittracker-production-api.up.railway.app:8080/api/v1/auth/register', {
            method: 'POST',
            headers: {
        ...
        if (response.ok) {
            ...
            try {
                await fetch('https://habittracker-production-api.up.railway.app:8080/api/v1/auth/request-verify-token', {
                    method: 'POST',
                    headers: {
                        'accept': 'application/json',
                        'Content-Type': 'application/json'
